...
export const packs: Packs = [
  ...
  },
  {
    name: '1',
    samples: [
      { id: 8, emoji: '💥', url: `${audio_path}/1/0_crash.mp3` },
      { id: 9, emoji: '🐮', url: `${audio_path}/1/1_cow.mp3` },
      { id: 10, emoji: '🪇', url: `${audio_path}/1/2_shaker.mp3` },
      { id: 11, emoji: '👨', url: `${audio_path}/1/3_tom.mp3` },
      { id: 12, emoji: '🪵', url: `${audio_path}/1/4_wood.mp3` },
